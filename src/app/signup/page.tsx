...
import { Mail, Lock, User, ArrowRight, Eye, EyeOff, Shield, Heart } from 'lucide-react'
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-surface overflow-hidden">
      ...
      <div className="hidden lg:flex relative bg-green-deep flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image 
            src="/hero_golf_course_1775018142834.png" 
            alt="Elite Golf Experience" 
            fill 
        ...
        <div className="relative z-20 mb-20">
          ...
          >
            <h2 className="text-4xl xl:text-5xl font-[family-name:var(--font-heading)] text-white font-bold leading-tight mb-6">
              ...
              <span className="text-green-light">with the Elite.</span>
            </h2>
            <p className="text-white/60 text-lg max-w-md leading-relaxed mb-8">
              Join the club where your passion for golf meets a greater purpose. Play for precision, win for causes.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-white font-bold text-sm">Elite Membership</div>
                <div className="text-white/40 text-xs uppercase tracking-widest">Global Network</div>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20">
              ...
              <div>
                <div className="text-white font-bold text-sm">Direct Impact</div>
                <div className="text-white/40 text-xs uppercase tracking-widest">Global Charities</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-20 mt-auto">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-black/20 backdrop-blur-md rounded-full border border-white/10">
            ...
            <span className="text-white/50 text-[10px] uppercase tracking-widest font-bold">Joining 2,500+ Active Members</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 relative text-text">
        ...
        <motion.div
          ...
          className="relative w-full max-w-sm z-10 bg-white lg:bg-transparent p-8 sm:p-10 rounded-[2.5rem] shadow-xl lg:shadow-none"
        >
          ...
          <div className="mb-10">
            <h1 className="text-3xl font-bold font-[family-name:var(--font-heading)] mb-2">Create Account</h1>
            <p className="text-text-muted text-sm font-medium">Join the BirdieFund movement today</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              ...
              <div className="relative group">
                <User size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-text-dim group-focus-within:text-green transition-colors" />
                <input
                  type="text"
                  value={fullName}
            ...
            <div>
              <label className="text-xs font-bold text-text-secondary uppercase tracking-widest mb-2 block">Create Password</label>
              <div className="relative group">
          ...
          <p className="text-center text-text-muted text-sm mt-10">
            Already a member?{' '}
            <Link href="/login" className="text-green hover:text-green-dark transition-colors font-bold underline decoration-green/30 underline-offset-4">
              Sign in
            </Link>
          </p>
        </motion.div>
